  ...
  const statsBar = s ? `
    <div class="card" style="padding:10px 16px">
      <div class="row" style="gap:22px;flex-wrap:wrap;align-items:baseline">
        <span title="A known company + scope ≥ yours (Senior EM / Head / Field CTO) + range ≥ current. The most important market signal.">
  ...
  el.innerHTML = `
    ...
    <div style="margin-bottom:10px">
      <a href="#career" style="text-decoration:none;display:inline-block;padding:6px 12px;
        ...
        🧭 Career analysis — growing toward Director / Head of Eng →</a>
    ...
    <div class="card" id="baroCard">
      <h3>📈 Market barometer — demand for EM / Head of Engineering roles (+ your inbound)</h3>
      <div class="muted" style="font-size:.85em;margin-bottom:8px">Total openings on the market (Europe, remote) for EM / Head of Engineering roles — a monthly trend against your inbound (bars).
    ...
    trackChart(new Chart(document.getElementById("baroChart"), {
      data: {
        ...
        datasets: [
          ...
          { type: "line", label: "Market: EM (Europe remote)", data: bpts.map((p) => p.em_openings),
