  ...
  el.innerHTML = `
    ...
    <div class="card mt">
      ...
      <div class="row" style="flex-wrap:wrap;gap:12px">
        ...
        <label class="muted">Rent/mo (${window.APP_CURRENCY || "PLN"})<br><input data-num id="txRent" value="${fmt.grouped(d.assumptions.tax_rental_monthly)}" style="width:130px"></label>
        <label class="muted">Business income tax rate (%)<br><input data-num id="txBiz" value="${d.assumptions.tax_biz_rate_pct ?? 12}" style="width:110px"></label>
        ...
        <label class="muted">Business social security/mo (${window.APP_CURRENCY || "PLN"})<br><input data-num id="txZus" value="${fmt.grouped(d.assumptions.tax_zus_monthly)}" style="width:130px"></label>
