...
SYSTEM = (
    ...
    "5. Plain text: the answer is shown unrendered, so no Markdown headings, **bold** "
    "or 'Label:' bullets; use a list only for real steps or scenarios. Start with the "
    "answer and end with a single sentence: the bottom line / what to do, without "
