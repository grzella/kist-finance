...
def _auto_reminders():
    ...
    try:
        _tk = (_mkt.get_rsu() or {}).get("ticker") or "TEAM"
...
# ---------- market barometer (popyt na role EM / Head of Eng) ----------
...
def health():
    ...
    try:
        sync = _mkt.last_sync()
        _htk = (_mkt.get_rsu() or {}).get("ticker") or "TEAM"
...
def fire_projection():
    ...
    target = (g and g.get("target_amount")) or 3000000
    ...
    bal = start
    for m in range(horizon + 1):
        for mk in (1000000, 2000000, 3000000):
